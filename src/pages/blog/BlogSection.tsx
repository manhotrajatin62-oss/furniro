...
const BlogSection = () => {
  ...
  return (
    <div className="flex flex-col gap-13 md:w-100 lg:w-150 xl:w-190">
      {blogData?.map((item) => {
        return (
          <div key={item?.heading}>
            ...
            <div className="mt-4 flex items-center gap-4 text-xs whitespace-nowrap sm:gap-9 sm:text-sm lg:text-base">
            ...
            <h1 className="mt-4 text-2xl font-medium xl:text-3xl">
              {item?.heading}
            </h1>
